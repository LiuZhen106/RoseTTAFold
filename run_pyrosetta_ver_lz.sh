...
############################################################
# 1. generate MSAs
# Input: input.fa, Output: t000_.msa0.a3m
############################################################
...
# Input: t000_.msa0.a3m t000_.msa0.tmp.horiz, Output: t000_.ss2
############################################################
if [ ! -s $WDIR/t000_.ss2 ]
then
    echo "Running PSIPRED"
    $PIPEDIR/input_prep/make_ss_lz.sh $WDIR/t000_.msa0.a3m $WDIR/t000_.ss2 > $WDIR/log/make_ss.stdout 2> $WDIR/log/make_ss.stderr
fi


############################################################
# 3. search for templates
# Input: t000_.ss2 t000_.msa0.a3m, Output: t000_.hhr t000_.atab
############################################################
#DB="$PIPEDIR/pdb100_2021Mar03/pdb100_2021Mar03"
DB="/root/liuzhen/RoseTTAFold/pdb100_2021Mar03/pdb100_2021Mar03"
if [ ! -s $WDIR/t000_.hhr ]
then
